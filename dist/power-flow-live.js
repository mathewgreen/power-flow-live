      ...
      <ha-card .header=${this._config.title} style="${cardStyle}">
        <div class="card-content">
          <div class="row" style="height:100%;">
            ...
            <div class="col">
              <div class="row">
                ${elementsByPosition.top.length ? elementsByPosition.top.map(element => this.elementToHtml(element)) : x `<div class="spacer container-top"></div>`}
              </div>
              <div class="row">
                ${elementsByPosition.middle.map(element => this.elementToHtml(element, true))}
              </div>
              <div class="row">
                ${elementsByPosition.bottom.length ? elementsByPosition.bottom.map(element => this.elementToHtml(element)) : x `<div class="spacer container-bottom"></div>`}
              </div>
            </div>
            <div class="col">
